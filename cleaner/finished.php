...
<!-- site metas -->
<title>Mipoclean Cleaner Finished Page</title>
...
<body>
  ...
  <div class="header_section background_bg">
    ...
    <div class="telg">
        <center><h1 style="font-size: 90px; color: #89CBEB"> &#128195; Finished Order &#128195; </h1>  </center>
      </div>
      <div class="mt-5">
          <table class="table table-bordered text-center table-striped">
            ...
            <?php
              ...
              $query = "SELECT * FROM pesanan where status = 'Finished'";
            ...
            <tr>
              ...
              <td><?= $data['services'] ?></td>
              <td>
                <form method='POST' onsubmit="return confirm('Are you sure want to undo the order?');">
                  <input hidden type='text' name='id' value="<?= $data['id'] ?>">
                  <button type='submit' name ='btnUpdate' class='btn btn-info'>Undo Task</button>
                  </form>
              </td>
              <td>
                <form onsubmit="return confirm('Are you sure want to delete the order?');" method='POST'>
            ...
            <?php
              if(isset($_POST['btnHapus']))
              {
                ...
                if($koneksi)
                {
                    ...
                    echo "<meta http-equiv=\"refresh\" content=\"3;URL=finished.php\">";
                    echo "<p class='alert alert-info text-center'><b>Order deleted successfully.</b></p>";
                    
                }
                else
                {
                  echo "<p class='alert alert-danger text-center'><b>Order deleted unsuccessfully.</b></p>";
                }
              }    
            ?>
            ...
            <?php
              if(isset($_POST['btnUpdate']))
              {
                ...
                {
                    $done = "Processing";
                    $sql = "UPDATE pesanan SET status = '$done' WHERE id = $id";
                    $query = mysqli_query($koneksi, $sql);
                    
                    echo "<meta http-equiv=\"refresh\" content=\"3;URL=finished.php\">";
                    echo "<p class='alert alert-info text-center'><b>You've undo the task! Damn, whats wrong with your services? :/</b></p>";
