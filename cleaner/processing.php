...
<!-- site metas -->
<title>Mipoclean Cleaner Processing Page</title>
...
<body>
  ...
  <div class="header_section background_bg">
    ...
    <div class="telg">
        <center><h1 style="font-size: 90px; color: red"> &#128721; Unfinished Order &#128721; </h1>  </center>
      </div>
      <div class="">
          ...
          <thead class="thead-dark">
            ...
            <?php
              ...
              $query = "SELECT * FROM pesanan where status = 'Processing'";
            ...
            <tr>
              ...
              <td><?= $data['services'] ?></td>
              <td>
                <form method='POST' onsubmit="return confirm('Are you sure want to finish the order?');">
                  <input hidden type='text' name='id' value="<?= $data['id'] ?>">
                  <button type='submit' name ='btnUpdate' class='btn btn-info'>Finish Task</button>
                  </form>
              </td>
              <td>
            ...
            <?php
              if(isset($_POST['btnHapus']))
              {
                ...
                if($koneksi)
                {
                    ...
                    echo "<meta http-equiv=\"refresh\" content=\"3;URL=processing.php\">";
            ...
            <?php
              if(isset($_POST['btnUpdate']))
              {
                ...
                if($koneksi)
                {
                    ...
                    echo "<meta http-equiv=\"refresh\" content=\"3;URL=processing.php\">";
                    echo "<p class='alert alert-info text-center'><b>You've finished the task! Congrats!!!.</b></p>";
