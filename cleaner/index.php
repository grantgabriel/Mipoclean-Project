  ...
  <div class="header_section background_bg">
    ...
    <div>
      <center>
        ...
        <tr>
            <td>
              <div class="card border-info mb-5 mt-5 mr-5 bg-info" style="max-width: 30rem;">
                <div class="card-header bg-transparent border-info text-light"><p class='alert alert-success text-center'><b>Finished Tasks</b></p></div>
                  <div class="card-body text-light">
                    <img class="card-img-top rounded" src="../images/money.jpg" alt="Raining Money Picture">
                    <h1 class="card-title text-light"></h1>
                    <h2 class="card-text text-light"><center>Thank you for your hard work. Your services is our money maker. &#128512;</center></h2>
                    <center><a type="button" class="btn btn-light btn-lg btn-block" href="finished.php">Finished Task List</a></center>
                  </div>
                <div class="card-footer bg-transparent border-info text-light"><i>"The only thing standing between you and outrageous success is continuous progress."</i> <br><br> — Grant Gabriel Tambunan, famous speaker</div>
              </div>
            </td>
            <td>
              <div class="card border-info mb-5 mt-5 ml-5 bg-info" style="max-width: 30rem;">
                <div class="card-header bg-transparent border-info text-light"><p class='alert alert-danger text-center'><b>Unfinished order</b></p></div>
                  <div class="card-body text-light">
                    <img class="card-img-top rounded" src="../images/angry.jpg" alt="Angry Emoji Picture">
                    <h1 class="card-title text-light"></h1>
                    <h2 class="card-text text-light"><center>How dare you not do any of these order? Get back to work now! &#128545;</center></h2>
                    <center><a type="button" class="btn btn-light btn-lg btn-block" href="processing.php">Unfinished Task List</a></center>
                  </div>
                <div class="card-footer bg-transparent border-info text-light"><i>"Those who always lazy and did'nt do their work, shall receive their termination letter."</i> <br><br> — Grant Gabriel Tambunan, on his bossy mode</div>
              </div>
            </td>
          </tr>
        </table>
