...
<!-- site metas -->
<title>Mipoclean Banned Cleaner</title>
...
<body>
  ...
  <div class="header_section background_bg">
    ...
    <div class="container">
      <div class="">
      <div class="telg">
        <center><h1 style="font-size: 90px; color: red"> &#9940; BANNED WORKER &#9940; </h1>  </center>
      </div>
          ...
          <thead class="thead-dark">
            ...
            <?php
              ...
              $query = "SELECT * FROM account where level = 2 and status = 'Banned!'";
            ...
            <tr>
              ...
              <td>
                <form method='POST'>
                  ...
                  <button type='submit' name ='btnUpdate' class='btn btn-info'>Unban</button>
                  </form>
              </td>
              <td>
          ...
          <?php
            if(isset($_POST['btnHapus']))
            {
              ...
              if($koneksi)
              {
                  ...
                  echo "<meta http-equiv=\"refresh\" content=\"3;URL=databannedcl.php\">";
