...
<!-- site metas -->
<title>Mipoclean User List</title>
...
<body>
  ...
  <div class="header_section background_bg">
    ...
    <div class="container">
      <div class="">
      <div class="telg">
        <center><h1 style="font-size: 90px; color: #89CBEB"> &#128195; User List &#128195; </h1>  </center>
      </div>
          ...
          <thead class="thead-dark">
            ...
            <?php
              ...
              $query = "SELECT * FROM account where level = 1 and status = ''";
            ...
            <tr>
              ...
              <td>
                <form method='POST'>
                  ...
                  <button type='submit' name ='btnUpdate' class='btn btn-danger'>Banned</button>
                  </form>
              </td>
              <td>
