...
<!-- site metas -->
<title>Mipoclean Banned User List</title>
...
<body>
  ...
  <div class="header_section background_bg">
    ...
    <div class="container">
      <div class="">
      <div class="telg">
        <center><h1 style="font-size: 90px; color: red"> &#9940; BANNED USER &#9940; </h1>  </center>
      </div>
          ...
          <thead class="thead-dark">
            ...
            <?php
              ...
              $query = "SELECT * FROM account where level = 1 and status = 'Banned!'";
            ...
            <tr>
              ...
              <td>
                <form method='POST'>
                  ...
                  <button type='submit' name ='btnUpdate' class='btn btn-info'>Unbanned</button>
                  </form>
              </td>
              <td>
          ...
          <?php
            if(isset($_POST['btnHapus']))
            {
              ...
              if($koneksi)
              {
                  ...
                  echo "<meta http-equiv=\"refresh\" content=\"3;URL=databannedus.php\">";
                  echo "<p class='alert alert-info text-center'><b>Data Akun Berhasil Dihapus.</b></p>";
                  
              }
              else
              {
                echo "<p class='alert alert-danger text-center'><b>Data Akun Tidak Berhasil Dihapus.</b></p>";
              }
            }    
            ?>
            ...
            <?php
              if(isset($_POST['btnUpdate']))
              {
                ...
                {
                    $done = "";
                    $sql = "UPDATE account SET status = '$done' WHERE id = $id";
                    $query = mysqli_query($koneksi, $sql);
                    
                    echo "<meta http-equiv=\"refresh\" content=\"3;URL=datauser.php\">";
                    echo "<p class='alert alert-info text-center'><b>User banned successfully!.</b></p>";
