...
<!-- site metas -->
<title>Mipoclean Cleaner List</title>
...
<body>
  ...
  <div class="header_section background_bg">
    ...
    <div class="container">
      <div class="">
      <div class="telg">
        <center><h1 style="font-size: 90px; color: #89CBEB"> &#128195; Cleaner List &#128195; </h1>  </center>
      </div>
          ...
          <thead class="thead-dark">
            ...
            <?php
              ...
              $query = "SELECT * FROM account where level = 2 and status = ''";
            ...
            <tr>
              ...
              <td>
                <form method='POST'>
                  ...
                  <button type='submit' name ='btnUpdate' class='btn btn-danger'>Fire!</button>
                  </form>
              </td>
              <td>
          ...
          <?php
            if(isset($_POST['btnHapus']))
            {
              ...
              if($koneksi)
              {
                  ...
                  echo "<meta http-equiv=\"refresh\" content=\"3;URL=datacleaner.php\">";
...
<?php
              if(isset($_POST['btnUpdate']))
              {
                ...
                if($koneksi)
                {
                    ...
                    echo "<meta http-equiv=\"refresh\" content=\"3;URL=datacleaner.php\">";
                    echo "<p class='alert alert-info text-center'><b>Worker banned successfully!.</b></p>";
