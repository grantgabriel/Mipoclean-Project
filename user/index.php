          ...
          <div class="col-md-9">
            <div class="menu_text">
              <ul>
                <div class="togle_3">
                  <div class="menu_main">
                    <div class="padding_left0"><a href="#" type="button" data-toggle="modal" data-target="#exampleModalScrollable"></a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-5 mr-5">
            ...
            <h1 class="banner_taital">Welcoming <?= $_SESSION['username'] ?></h1>
            <h3 class="banner_text text-dark">Professional house clean in the world. Your house clean is our priority.</h3>
            <div class="contact_bt"><a class="btn btn-dark" href="../contact.php">CONTACT US<span class="contact_padding"><img src="images/contact-icon.png"></span></a></div>
          </div>
          <div>
    ...
    <div class="choose_section layout_padding">
      <div class="container">
        ...
        <div class="choose_section_2 layout_padding">
          ...
          <div class="get_bt"><a href="developer.php">DEVELOPER</a></div>
        </div>
      </div>
    </div>
    <!-- choose section end -->
        ...
        <div class="team_section_2 layout_padding">
          <div class="container">
            ...
            <div class="images_main">
              <div class="row">
                <div class="col-sm-7">
                  <h2 class="consectetur_text_1">Vacuum Cleaner</h2>
            ...
            <div class="card card1 h-100">
              <div class="card-body">
                ...
                <div class="d-grid my-3">
                  <a class="btn btn-outline-dark btn-block" href="basic.php">See More</a>
                </div>
                </center>
                <ul>
          ...
          <div class="card card2 h-100">
            <div class="card-body">
              <center>
                ...
                <br><br>
                <div class="d-grid my-3">
                  <a class="btn btn-outline-dark btn-block" href="standard.php">See More</a>
                </div>
                </center>
                <ul>
        ...
        <div class="col-lg-4 col-md-12 mb-4">
          <div class="card card3 h-100">
            <div class="card-body">
              ...
              <br><br>
              <div class="d-grid my-3">
              <a class="btn btn-outline-dark btn-block" href="premium.php">See More</a>
              </div>
              </center>
              <ul>
