...
<body>
  <!--header section start -->
    ...
    <div class="wrap">
            ...
            <div class="update_id">
                <label for="idup" > <h4>New Username</h4></label> 
                <input type="name" name="" id="name" placeholder="Input New Username">
            </div>

            <div class="update_email">
                <label for="emailup" > <h4>New Email</h4></label> 
                <input type="email" name="" id="emailup" placeholder="Input New Email">
            </div>
